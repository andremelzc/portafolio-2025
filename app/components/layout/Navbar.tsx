...
export default function Navbar() {
  ...
  const { navRef, indicatorStyle, setLinkRef } = useIndicatorPosition(
    activeSection,
    isExpanded // Usar isExpanded en lugar de isScrolled
  );
  ...
  return (
    <div
      className={`fixed left-0 right-0 z-50 flex justify-center ${containerClasses.position} ${containerClasses.transition}`}
    >
      <nav
        ref={navRef}
