...
export default function Button({
  ...
  const variantClasses = {
    primary: "bg-accent text-background hover:opacity-90 focus:ring-accent",
    secondary: "bg-muted text-foreground hover:opacity-80 focus:ring-muted",
    outline: "border border-border text-foreground hover:bg-muted focus:ring-accent",
    ghost: "text-foreground hover:bg-muted hover:bg-opacity-50 focus:ring-muted",
  };
